...
The long format is generally preferred is because it has more of a clear overview. Wide format data frame is still fine for small, simple comparisons, but long format is the standard for time-series work because it’s more tidy.
